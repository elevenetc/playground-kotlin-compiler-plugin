...
fun IrPluginContext.referenceCompanionPropertyFunction(
    ...
    propertyName: String,
    functionName: String
): IrCompanionPropertyFunctionCall {
    ...
    return IrCompanionPropertyFunctionCall(companionObjectSymbol, propertyGetter, funcSymbol)
}

data class IrCompanionPropertyFunctionCall(
    val irClass: IrClassSymbol,
    val irProperty: IrSimpleFunction,
    val irFun: IrSimpleFunctionSymbol,
    val arguments: List<IrExpression> = emptyList()
)